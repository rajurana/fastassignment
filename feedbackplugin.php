...
/**
 * Abstract class for feedback_plugin inherited from fastassignment_plugin abstract class.
 *
 * @package   mod_fastassignment
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class fastassignment_feedback_plugin extends fastassignment_plugin {
     ...
     *      'component' => FASTASSIGNFEEDBACK_XYZ_COMPONENT,
     *      'filearea' => FASTASSIGNFEEDBACK_XYZ_FILEAREA,
     *      'itemid' => $grade->id
     * ]
     *
