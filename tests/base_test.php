 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_fastassignment_base_testcase extends advanced_testcase {
    ...
    /**
     * Setup function - we will create a course and add an fastassignment instance to it.
     */
    ...
    protected function create_instance($params=array()) {
        ...
        return new mod_fastassignment_testable_assign($context, $cm, $this->course);
    }
...
class_alias('mod_fastassignment_testable_assign', 'testable_assign');
