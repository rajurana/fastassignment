...
/**
 * Unit tests for the privacy legacy polyfill for mod_fastassignment.
 *
...
require_once($CFG->dirroot . '/mod/fastassignment/submission/comments/locallib.php');
 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_fastassignmentsubmission_privacy_legacy_polyfill_test extends advanced_testcase {
    ...
    public function test_get_context_for_userid_within_submission() {
        ...
        $mock = $this->createMock(test_fastassignsubmission_legacy_polyfill_mock_wrapper::class);
    ...
    public function test_get_student_user_ids() {
        $teacherid = 107;
        $assignid = 15;
        $useridlist = new \mod_fastassignment\privacy\useridlist($teacherid, $assignid);
        $mock = $this->createMock(test_fastassignsubmission_legacy_polyfill_mock_wrapper::class);
        $mock->expects($this->once())
            ->method('get_return_value')
    ...
    public function test_export_submission_user_data() {
        ...
        $subplugin = new fastassignment_submission_comments($fastassignment, 'comment');
...
/**
 * Legacy polyfill test class for the fastassignsubmission_provider.
 *
 * @copyright   2018 Adrian Greeve <adriangreeve.com>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class test_legacy_polyfill_submission_provider implements \mod_fastassignment\privacy\fastassignsubmission_provider {
    use \mod_fastassignment\privacy\submission_legacy_polyfill;
    /**
     ...
     * NOTE if your subplugin must have an entry in the fastassignment_grade table to work, then this
     * method can be empty.
     *
     ...
     * the sql query in \mod_fastassignment\privacy\provider::find_grader_info() Then you need to provide some sql to retrive those
     ...
     */
    public static function _get_student_user_ids(\mod_fastassignment\privacy\useridlist $useridlist) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }

    /**
     * This method is used to export any user data this sub-plugin has using the fastassignment_plugin_request_data object to get the
     * context and userid.
     ...
     * - user object
     *
     * @param  fastassignment_plugin_request_data $exportdata Contains data to help export the user information.
     */
    public static function _export_submission_user_data(\mod_fastassignment\privacy\fastassignment_plugin_request_data $exportdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
     ...
     */
    public static function _delete_submission_for_context(\mod_fastassignment\privacy\fastassignment_plugin_request_data $requestdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
     ...
     */
    public static function _delete_submission_for_userid(\mod_fastassignment\privacy\fastassignment_plugin_request_data $requestdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
}
/**
 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class test_fastassignsubmission_legacy_polyfill_mock_wrapper {
    /**
