@mod @mod_fastassignment @javascript
Feature: In an assignment, students can comment in their submissions
  ...
  Scenario: Student comments an assignment submission
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | fastassignsubmission_onlinetext_enabled |
      | fastassignment   | C1     | assign1  | Test assignment name | Test assignment description | 1 |
  ...
  Scenario: Teacher can comment on an offline assignment
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | fastassignsubmission_onlinetext_enabled | assignmentsubmission_file_enabled | fastassignfeedback_comments_enabled |
      | fastassignment   | C1     | assign1  | Test assignment name | Test assignment description | 0 | 0 | 1 |
