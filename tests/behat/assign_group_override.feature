...
Feature: fastassignment group override
  ...
  Background:
    ...
    And the following "activities" exist:
      | activity | name                 | intro                   | course | idnumber | fastassignsubmission_onlinetext_enabled |
      | fastassignment   | Test assignment name | Submit your online text | C1     | assign1  | 1                                   |
  ...
  Scenario: Override a group when teacher is in no group, and does not have accessallgroups permission, and the activity's group mode is "separate groups"
    ...
    And the following "activities" exist:
      ...
      | fastassignment   | Assignment 2 | Assignment 2 description | C1     | assign2  | 1         |
