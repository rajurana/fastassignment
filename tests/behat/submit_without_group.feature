...
Feature: Submit assignment without group
  ...
  Scenario: Switch between group modes
    ...
    And the following "activities" exist:
      | activity | course | idnumber | name                     | intro                       | fastassignsubmission_onlinetext_enabled | preventsubmissionnotingroup | teamsubmission |
      | fastassignment   | C1     | assign1  | Allow default group      | Test assignment description | 1                                   | 0                           | 1              |
      | fastassignment   | C1     | assign2  | Require group membership | Test assignment description | 1                                   | 1                           | 1              |
      | fastassignment   | C2     | assign2  | Require group membership | Test assignment description | 1                                   | 1                           | 1              |
      | fastassignment   | C3     | assign2  | Require group membership | Test assignment description | 1                                   | 1                           | 1              |
