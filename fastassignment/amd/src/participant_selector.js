 ...
 *
 * @module     mod_fastassignment/participants_selector
...
define(['core/ajax', 'jquery', 'core/templates'], function(ajax, $, templates) {
    ...
    return /** @alias module:mod_fastassignment/participants_selector */ {
            ...
            ajax.call([{
                ...
                $.each(results, function(index, user) {
                    ...
                    if (show) {
                        ...
                        promises.push(templates.render('mod_fastassignment/list_participant_user_summary', ctx).then(function(html) {
