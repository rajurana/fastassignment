...
/**
 * mod_fastassignment workflow state updated event.
 *
...
/**
 * mod_fastassignment workflow state updated event class.
 *
...
class workflow_state_updated extends base {
     ...
     */
    public static function create_from_user(\fastassignment $fastassignment, \stdClass $user, $state) {
        $data = array(
    ...
    public static function get_name() {
        return get_string('eventworkflowstateupdated', 'mod_fastassignment');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('setmarkingworkflowstateforlog', 'fastassignment', $a);
