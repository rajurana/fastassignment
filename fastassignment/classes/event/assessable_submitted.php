...
/**
 * The mod_fastassignment assessable submitted event.
 *
...
/**
 * The mod_fastassignment assessable submitted event class.
 *
...
class assessable_submitted extends base {
     ...
     */
    public static function create_from_submission(\fastassignment $fastassignment, \stdClass $submission, $editable) {
        global $USER;
    ...
    public static function get_name() {
        return get_string('eventassessablesubmitted', 'mod_fastassignment');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $this->set_legacy_logdata('submit for grading', $this->fastassignment->format_submission_for_log($submission));
