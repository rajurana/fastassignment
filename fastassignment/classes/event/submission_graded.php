...
/**
 * The mod_fastassignment submission graded event.
 *
...
/**
 * The mod_fastassignment submission graded event class.
 *
 * @package    mod_fastassignment
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_graded extends base {
     ...
     */
    public static function create_from_grade(\fastassignment $fastassignment, \stdClass $grade) {
        $data = array(
        ...
        $event->add_record_snapshot('fastassignment_grades', $grade);
        return $event;
    }
    ...
    public static function get_name() {
        return get_string('eventsubmissiongraded', 'mod_fastassignment');
    }
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'fastassignment_grades';
    }
    ...
    protected function get_legacy_logdata() {
        $grade = $this->get_record_snapshot('fastassignment_grades', $this->objectid);
        $this->set_legacy_logdata('grade submission', $this->fastassignment->format_grade_for_log($grade));
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'fastassignment_grades', 'restore' => 'grade');
    }
}
