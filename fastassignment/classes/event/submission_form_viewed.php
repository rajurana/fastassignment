...
/**
 * The mod_fastassignment submission form viewed event.
 *
...
/**
 * The mod_fastassignment submission form viewed event class.
 *
...
class submission_form_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionformviewed', 'mod_fastassignment');
    }
    ...
    protected function get_legacy_logdata() {
        if ($this->relateduserid == $this->userid) {
            ...
            $title = get_string('editsubmissionother', 'fastassignment', fullname($user));
        }
