...
/**
 * The mod_fastassignment submission status viewed event.
 *
...
/**
 * The mod_fastassignment submission status viewed event class.
 *
...
class submission_status_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionstatusviewed', 'mod_fastassignment');
    }
    ...
    protected function get_legacy_logdata() {
        $this->set_legacy_logdata('view', get_string('viewownsubmissionstatus', 'fastassignment'));
