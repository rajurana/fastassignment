...
/**
 * The mod_fastassignment submission updated event.
 *
...
/**
 * The mod_fastassignment submission updated event class.
 *
...
abstract class submission_updated extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionupdated', 'mod_fastassignment');
    }
