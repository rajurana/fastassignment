...
/**
 * The mod_fastassignment assignment batch set workflow stated viewed event.
 *
...
class batch_set_workflow_state_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventbatchsetworkflowstateviewed', 'mod_fastassignment');
    }
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewbatchsetmarkingworkflowstate', 'fastassignment');
