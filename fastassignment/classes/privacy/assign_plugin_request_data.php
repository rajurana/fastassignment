...
/**
 * This file contains the mod_fastassignment fastassignment_plugin_request_data class
 *
 * For fastassignment plugin privacy data to fulfill requests.
 *
...
/**
 * An object for fulfilling an fastassignment plugin data request.
 *
 * @copyright  2018 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class fastassignment_plugin_request_data {
    ...
    /** @var fastassignment The fastassignment object */
    protected $fastassignment;

    /**
     * Object creator for fastassignment plugin request data.
     *
     ...
     */
    public function __construct(\context $context, \fastassignment $fastassignment, \stdClass $pluginobject = null, array $subcontext = [],
            \stdClass $user = null) {
     ...
     * Getter for this attribute.
     *
     * @return object The fastassignment plugin object
     */
     ...
     * Getter for this attribute.
     *
     * @return fastassignment The fastassignment object.
     */
    ...
    /**
     * A method to conveniently fetch the fastassignment id.
     *
     * @return int The fastassignment id.
     */
    public function get_assignid() {
        return $this->fastassignment->get_instance()->id;
    }
    ...
    public function populate_submissions_and_grades() {
        ...
        $params['fastassignment'] = $this->get_assign()->get_instance()->id;
        $this->submissions = $DB->get_records_select('fastassignment_submission', "assignment = :fastassignment AND userid $sql", $params);
        $this->grades = $DB->get_records_select('fastassignment_grades', "assignment = :fastassignment AND userid $sql", $params);
    }
}
