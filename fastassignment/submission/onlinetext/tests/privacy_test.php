...
class fastassignsubmission_online_privacy_testcase extends \mod_fastassignment\tests\mod_fastassignment_privacy_testcase {
    ...
    public function test_delete_submissions() {
        ...
        $data = $DB->get_records('fastasgnsubmsn_onlinetext', ['assignment' => $assign1->get_instance()->id]);
        ...
        $data = $DB->get_records('fastasgnsubmsn_onlinetext', ['assignment' => $assign2->get_instance()->id]);
