...
/**
 * Unit tests for (some of) mod/fastassignment/markerallocaion_test.php.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_fastassignment_markerallocation_testcase extends advanced_testcase {
    ...
    public function test_markerusers() {
        ...
        $assignelement = $this->getDataGenerator()->create_module('fastassignment', $record, $modulesettings);
        ...
        $oldmarkers = get_users_by_capability(context_course::instance($this->course->id), 'mod/fastassignment:grade', '', $sort);
        // New code, it must return 2 users: teacher1 and teacher2.
        $newmarkers = get_enrolled_users(context_course::instance($this->course->id), 'mod/fastassignment:grade', 0, 'u.*', $sort);
