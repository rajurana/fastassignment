...
I should be able to create an assignment with a due date relative to the course start date
  ...
  Scenario: As a student the due date for submitting my assignment is relative to my course start date
    ...
    And the following "activities" exist:
      | activity   | name                   | intro                         | course | idnumber    | fastassignsubmission_onlinetext_enabled | timeopen | duedate |
      | fastassignment     | Test assignment name   | Test assignment description   | C1     | assign0     | 1                                   |##first day of -4 months## | ##last day of -3 months## |
  ...
  Scenario: As a teacher, I should see the relative dates when reviewing assignment submissions
    ...
    And the following "activities" exist:
      | activity   | name                   | intro                         | course | idnumber    | fastassignsubmission_onlinetext_enabled | timeopen | duedate |
      | fastassignment     | Test assignment name   | Test assignment description   | C1     | assign0     | 1                                   |##first day of 4 months ago## | ##last day of 3 months ago## |
