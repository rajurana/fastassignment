 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_fastassignment_confirm_submission_form extends moodleform {
    /**
    ...
    public function definition() {
        ...
        $mform->addElement('static', 'confirmmessage', '', get_string('confirmsubmission', 'mod_fastassignment'));
