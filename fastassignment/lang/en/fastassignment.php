...
$string['modulename_help'] = 'The Fast Assignment activity module enables a teacher to create, select and modify writing assignment descriptions, collect student submissions, and provide grades and feedback manually or automatically.
Students can submit online text through the text editor, with access to a grammar checker and automated formative evaluation. Students can submit work individually or as a member of a group.
When reviewing assignments, teachers can generate a score and feedback comments automatically. Final grades are recorded in the gradebook.';
...
$string['getapikey'] = '<a href="https://virtualwritingtutor.com/get-an-api-key" target="_blank">API key</a>';
$string['getapikey_help'] = '<a href="https://virtualwritingtutor.com/get-an-api-key" target="_blank">Get API key </a> by clicking the link <a href="https://virtualwritingtutor.com/get-an-api-key" target="_blank">here</a>. CLick on API key from the first header followed by clicking register for an API key link. You will receive your copy of API key in mail. ';
$string['validateapibutton'] = 'Check My API KEY\'s remaining hits';
...
$string['settings_apikey_help'] = 'Please enter your API key. This API key is your unique identifier for sending text from the Fast Assignment activity to the <a href="https://virtualwritingtutor.com/" target="_blank">VirtualWritingTutor.com</a> for feedback and evaluation. If you do not have an API key, please visit  <a href="https://virtualwritingtutor.com/get-an-api-key/" target="_blank"> https://virtualwritingtutor.com/get-an-api-key</a>.';