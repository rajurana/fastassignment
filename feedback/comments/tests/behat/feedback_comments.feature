@mod @mod_fastassignment @fastassignfeedback @fastassignfeedback_comments
Feature: In an assignment, teachers can provide feedback comments on student submissions
  ...
  Scenario: Teachers should be able to add and remove feedback comments via the quick grading interface
    Given the following "activities" exist:
      | activity | course | idnumber | name             | fastassignsubmission_onlinetext_enabled | fastassignfeedback_comments_enabled |
      | fastassignment   | C1     | assign1  | Test assignment1 | 1                                   | 1                               |
