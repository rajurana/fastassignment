 ...
 *
 * Provides the necessary information needed to restore
 * one fastassignfeedback subplugin.
 *
 * @package   fastassignfeedback_comments
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_fastassignfeedback_comments_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_fastassignfeedback_comments_grade($data) {
        global $DB;
        ...
        $DB->insert_record('fastassignfeedback_comments', $data);
