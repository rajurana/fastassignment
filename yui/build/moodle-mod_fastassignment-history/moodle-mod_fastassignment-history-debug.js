YUI.add('moodle-mod_fastassignment-history', function (Y, NAME) {

// Define a function that will run in the context of a
// Node instance:
var CSS = {
        LINK: 'mod-fastassignment-history-link',
        OPEN: 'mod-fastassignment-history-link-open',
        CLOSED: 'mod-fastassignment-history-link-closed',
        PANEL: 'mod-fastassignment-history-panel'
    },
    COUNT = 0,
    TOGGLE = function() {
        var id = this.get('for'),
