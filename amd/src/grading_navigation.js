 ...
 *
 * @module     mod_fastassignment/grading_navigation
...
define(['jquery', 'core/notification', 'core/str', 'core/form-autocomplete',
        'core/ajax', 'mod_fastassignment/grading_form_change_checker'],
    ...
    var GradingNavigation = function(selector) {
        ...
        str.get_string('changeuser', 'mod_fastassignment').done(function(s) {
                autocomplete.enhance('[data-action=change-user]', false, 'mod_fastassignment/participant_selector', s);
            }
    ...
    GradingNavigation.prototype._loadAllUsers = function() {
        ...
        ajax.call([{
            methodname: 'mod_fastassignment_list_participants',
    ...
    GradingNavigation.prototype._checkClickOutsideConfigureFilters = function(event) {
        ...
        if (!configPanel.is(event.target) && configPanel.has(event.target).length === 0) {
            ...
            $(document).unbind('click.mod_fastassignment_grading_navigation');
        }
    };
    ...
    GradingNavigation.prototype._filterChanged = function() {
        ...
        if (filterlist.length) {
            ...
            str.get_string('nofilters', 'mod_fastassignment').done(function(s) {
        ...
        var preferenceNames = ['fastassignment_filter', 'fastassignment_workflowfilter', 'fastassignment_markerfilter'];
    ...
    GradingNavigation.prototype._selectNoUser = function() {
        ...
        if (checker.checkFormForChanges('[data-region="grade-panel"] .gradeform')) {
            ...
            str.get_strings([
                {key: 'unsavedchanges', component: 'mod_fastassignment'},
                {key: 'unsavedchangesquestion', component: 'mod_fastassignment'},
                {key: 'saveandcontinue', component: 'mod_fastassignment'},
    ...
    GradingNavigation.prototype._toggleExpandFilters = function(event) {
        ...
        if (expanded) {
            ...
            $(document).on('click.mod_fastassignment_grading_navigation', this._checkClickOutsideConfigureFilters.bind(this));
        }
    };
    ...
    GradingNavigation.prototype._setCountString = function(x, y) {
        ...
        var param = {x: x, y: y};
        str.get_string('xofy', 'mod_fastassignment', param).done(function(s) {
