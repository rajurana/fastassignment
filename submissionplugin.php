...
require_once($CFG->dirroot . '/mod/fastassignment/assignmentplugin.php');
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class fastassignment_submission_plugin extends fastassignment_plugin {
     ...
     * @param stdClass $submission the fastassignment_submission record being submitted.
     ...
     *
     * @param stdClass|false $submission - fastassignment_submission data if any
     ...
     *
     * @param stdClass $submission - fastassignment_submission data
     * @return void
     */
