...
/**
 * The mod_fastassignment submission_created abstract event.
 *
...
/**
 * The mod_fastassignment submission_created abstract event class.
 *
...
abstract class submission_created extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissioncreated', 'mod_fastassignment');
    }
    ...
    public static function get_other_mapping() {
        $othermapped = array();
        $othermapped['submissionid'] = array('db' => 'fastassignment_submission', 'restore' => 'submission');
