...
/**
 * The mod_fastassignment submission locked event.
 *
...
/**
 * The mod_fastassignment submission locked event class.
 *
 * @package    mod_fastassignment
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_locked extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionlocked', 'mod_fastassignment');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('locksubmissionforstudent', 'fastassignment', array('id' => $user->id, 'fullname' => fullname($user)));
