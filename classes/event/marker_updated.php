...
/**
 * The mod_fastassignment marker updated event.
 *
...
/**
 * The mod_fastassignment marker updated event class.
 *
...
class marker_updated extends base {
     ...
     */
    public static function create_from_marker(\fastassignment $fastassignment, \stdClass $user, \stdClass $marker) {
        $data = array(
    ...
    public static function get_name() {
        return get_string('eventmarkerupdated', 'mod_fastassignment');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('setmarkerallocationforlog', 'fastassignment', $a);
