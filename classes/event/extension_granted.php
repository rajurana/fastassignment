...
/**
 * The mod_fastassignment extension granted event.
 *
...
/**
 * The mod_fastassignment extension granted event class.
 *
 * @package    mod_fastassignment
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class extension_granted extends base {
     ...
     */
    public static function create_from_assign(\fastassignment $fastassignment, $userid) {
        $data = array(
    ...
    public static function get_name() {
        return get_string('eventextensiongranted', 'mod_fastassignment');
    }
