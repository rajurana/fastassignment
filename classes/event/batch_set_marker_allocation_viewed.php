...
/**
 * The mod_fastassignment batch set marker allocation viewed event.
 *
...
/**
 * The mod_fastassignment batch set marker allocation viewed event class.
 *
...
class batch_set_marker_allocation_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventbatchsetmarkerallocationviewed', 'mod_fastassignment');
    }
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewbatchmarkingallocation', 'fastassignment');
