...
/**
 * The mod_fastassignment all submissions downloaded event.
 *
...
/**
 * The mod_fastassignment all submissions downloaded event class.
 *
 * @package    mod_fastassignment
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class all_submissions_downloaded extends base {
    ...
    public static function get_name() {
        return get_string('eventallsubmissionsdownloaded', 'mod_fastassignment');
    }
    ...
    protected function get_legacy_logdata() {
        $this->set_legacy_logdata('download all submissions', get_string('downloadall', 'fastassignment'));
