...
/**
 * The mod_fastassignment grading table viewed event.
 *
...
/**
 * The mod_fastassignment grading table viewed event class.
 *
...
class grading_table_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventgradingtableviewed', 'mod_fastassignment');
    }
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewsubmissiongradingtable', 'fastassignment');
