...
/**
 * The fastassignsubmission_comments comment created event.
 *
...
namespace fastassignsubmission_comments\event;
defined('MOODLE_INTERNAL') || die();

/**
 * The fastassignsubmission_comments comment created event class.
 *
 * @package    fastassignsubmission_comments
 * @since      Moodle 2.7
 * @copyright  2013 Rajesh Taneja <rajesh@moodle.com>
