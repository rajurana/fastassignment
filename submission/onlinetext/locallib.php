...
class fastassignment_submission_onlinetext extends fastassignment_submission_plugin {
    ...
    private function get_onlinetext_submission($submissionid) {
        ...
        return $DB->get_record('fastasgnsubmsn_onlinetext', array('submission'=>$submissionid));
    }
    ...
    public function remove(stdClass $submission) {
        ...
        if ($submissionid) {
            $DB->delete_records('fastasgnsubmsn_onlinetext', array('submission' => $submissionid));
        }
        return true;
    }
    ...
    public function get_settings(MoodleQuickForm $mform) {
        ...
        $mform->setDefault('fastassignsubmission_onlinetext_enabled', true);
    }
    ...
    public function save(stdClass $submission, stdClass $data) {
        ...
        if ($onlinetextsubmission) {
            ...
            $updatestatus = $DB->update_record('fastasgnsubmsn_onlinetext', $onlinetextsubmission);
            ...
            $onlinetextsubmission->id = $DB->insert_record('fastasgnsubmsn_onlinetext', $onlinetextsubmission);
            $params['objectid'] = $onlinetextsubmission->id;
